    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      {saved.length > 0 ? (
        ...
        <div className="card p-16 text-center flex flex-col items-center gap-5">
          ...
          <div>
            <p className="text-xl font-bold text-gray-700 mb-2">Brak zapisanych fachowców</p>
            <p className="text-gray-400 text-sm max-w-xs mx-auto">
              Kliknij przycisk ❤️ na karcie fachowca, aby dodać go do swojej listy
            </p>
          </div>
          <Link
            to="/szukaj"
